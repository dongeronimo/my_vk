...
namespace entities
{
    Frame::Frame(
        ...
        :mSyncService(syncService),mCurrentFrame(currentFrame),
    ...
    bool Frame::BeginFrame()
    {
        ...
        vkResetFences(vk::Device::gDevice->GetDevice(), 1, &inFlightFences);
    ...
    void Frame::EndFrame()
    {
        ...
        uint32_t __currFrame = mCurrentFrame;
        presentInfo.pImageIndices = &__currFrame;
